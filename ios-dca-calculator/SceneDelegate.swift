...
//        }
    ...
    public func checkAuthentication(){
        if Auth.auth().currentUser == nil {
            ...
            guard let secondNavigationController = storyboard.instantiateViewController(withIdentifier: "SecondNavigationController") as? UINavigationController else {
                fatalError("Unable to instantiate SecondNavigationController from storyboard")
            }
